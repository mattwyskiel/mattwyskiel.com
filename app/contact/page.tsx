                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <Link href="https://github.com/mattwyskiel" className="text-teal-600 hover:text-teal-700 font-medium">
                                        GitHub
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://x.com/mattwyskiel" className="text-teal-600 hover:text-teal-700 font-medium">
                                        Twitter
                                    </Link>
                                </li>
                            </ul>
