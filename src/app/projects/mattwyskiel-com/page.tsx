...
export const metadata: Metadata = {
  ...
  description: "My personal portfolio website — custom-built and open source.",
  openGraph: {
    type: "website",
    title: "mattwyskiel.com | Matt Wyskiel",
    description:
      "My personal portfolio website — custom-built and open source.",
    url: "https://mattwyskiel.com/projects/mattwyskiel-com",
      ...
      <main className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm">
            <p className="text-muted-foreground mb-4">
              ...
              Built from the ground up with modern web technologies, it
              demonstrates my approach to web development and design.
            </p>
            <p className="text-muted-foreground">
              The site features a clean, minimal design that puts content first
              while maintaining excellent performance and accessibility. It
              includes a blog platform, project showcase, and comprehensive
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-card p-6 rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground">
                Responsive design that works flawlessly on all devices, from
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Built with Next.js 14 and TypeScript for type safety and
                  optimal performance
                </p>
              </div>
              <div className="text-center">
                <Zap className="h-12 w-12 text-brand mx-auto mb-3" />
                <h3 className="font-medium mb-2">Performance</h3>
                <p className="text-sm text-muted-foreground">
                  Optimized for speed with server-side rendering and static
                  generation
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Deployed on AWS with CDN for global performance and
                  reliability
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Implemented image optimization, lazy loading, and efficient
                    bundling
                  </p>
                </div>
              </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm">
            ...
            <p className="text-muted-foreground">
              The website is live and continuously evolving. Regular updates
              include new content, feature improvements, and design refinements.
              As an open-source project, it serves as both a portfolio piece and
