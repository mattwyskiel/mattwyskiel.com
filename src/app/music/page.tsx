...
export const metadata: Metadata = {
  title: "Music | Matt Wyskiel",
  description:
    "Mixes, tracks, and thoughts on audio from a music lover and mixer.",
  openGraph: {
    type: "website",
    title: "Music | Matt Wyskiel",
    description:
      "Mixes, tracks, and thoughts on audio from a music lover and mixer.",
    url: "https://mattwyskiel.com/music",
    ...
    <div className="min-h-screen bg-muted">
      <main className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-8 max-w-2xl">
          Music has always been a huge part of my life. Here you'll find mixes
          I've created, tracks I'm listening to, and thoughts on audio
          production.
        </p>
          ...
          <div className="bg-card rounded-lg shadow-xs overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                A mix of upbeat tracks perfect for summer drives with the
                windows down.
              </p>
          ...
          <div className="space-y-6">
            <div className="border-b pb-6">
              ...
              <p className="text-muted-foreground">
                My thoughts on creating the perfect mix and how to balance
                different elements in a track.
              </p>
            </div>
            <div className="border-b pb-6">
              <h3 className="font-medium text-lg mb-2">
              ...
              <p className="text-muted-foreground">
                Exploring the differences between vinyl and digital music, and
                why I appreciate both formats.
              </p>
            </div>
          </div>
        </section>
